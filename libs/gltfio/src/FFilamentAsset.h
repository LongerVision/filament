...
struct FFilamentAsset : public FilamentAsset {
    ...
    // tsl::robin_map<utils::Entity, utils::CString> mNodeExtras; // prideout
    // tsl::robin_map<utils::Entity, utils::FixedCapacityVector<utils::CString>> mMorphTargetNames; // prideout
