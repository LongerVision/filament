...
class Ktx2Provider : public TextureProvider {
public:
...
Ktx2Provider::Ktx2Provider(Engine* engine) : mEngine(engine) {
    ...
    mKtxReader->requestFormat(Texture::InternalFormat::DXT3_SRGBA);
    mKtxReader->requestFormat(Texture::InternalFormat::DXT3_RGBA);
